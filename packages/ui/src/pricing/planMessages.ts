...
const PLAN_MESSAGES: Record<string, MessageDescriptor> = {
  ...
  "Up to 12 taxonomy nodes": msg`Up to 12 taxonomy nodes`,
  ...
  "Unlimited taxonomy nodes": msg`Unlimited taxonomy nodes`,
  "200 AI drafts / month, pooled": msg`200 AI drafts / month, pooled`,
  "Shared taxonomy + review queue": msg`Shared taxonomy + review queue`,
  ...
  "Taxonomy nodes": msg`Taxonomy nodes`,
  "Shared taxonomy": msg`Shared taxonomy`,
