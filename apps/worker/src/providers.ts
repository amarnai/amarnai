...
/**
 * Builds the LLM provider config from environment variables.
 * Mirrors the same logic used in the API routes so the worker
 * honours the same env-based provider selection.
 */
...
/**
 * Builds the embedding provider config from environment variables.
 */
