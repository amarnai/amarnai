...
import type { FolderItem } from "./selection";
...
export function ReroutePopover({ folders, anchor, onCommit, onClose }: Props) {
  ...
  return (
    <div
      ref={panelRef}
      className="em-reroute-panel"
      role="dialog"
      aria-label="Re-route thread"
    >
      ...
      <ul className="em-reroute-list" role="listbox">
        {filtered.length === 0 && (
          <li className="em-reroute-empty">No folders match</li>
        )}
