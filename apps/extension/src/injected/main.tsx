...
// than linked from a CDN: this document renders inside Gmail, and a webfont
// request from there would be a third-party call on the user's mail page.
...
// The panel iframe injected into Gmail's sidebar.
//
...
// matches whatever the user chose there rather than guessing from Gmail's theme
// (which is not readable from this frame anyway).
