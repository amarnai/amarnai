...
// body, and an optional action target (a thread to open). Feature-agnostic: add
// a case per producer. Kept per-platform because the Lingui catalogs differ;
// this mirrors the web/extension renderers.
