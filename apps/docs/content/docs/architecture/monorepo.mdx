...
description: How the Aziru codebase is organised across apps and packages.
---
...
Aziru has three active clients: the **web app** (`apps/web`), the **browser extension** (`apps/extension`, a Chrome/Firefox MV3 side-panel), and the **marketing site** (`apps/site`). All three share logic through framework-free packages (`@aziru/core`, `@aziru/api-client`, `@aziru/tokens`, `@aziru/i18n`). The **mobile app** (`apps/mobile`) is shelved; see the repo `CLAUDE.md`.
