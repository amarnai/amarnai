...
Get a key from [Google AI Studio](https://aistudio.google.com/apikey). `text-embedding-004` produces 768-dimensional vectors and is free within Google's quota limits.
