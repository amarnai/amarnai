---
title: Self-Hosting
description: Run Aziru on your own infrastructure using Docker Compose.
---

Aziru ships as a set of Docker images that start with a single `docker compose` command. All services (web UI, API, background worker, Postgres, and Redis) are defined in `docker-compose.selfhost.yml`.
